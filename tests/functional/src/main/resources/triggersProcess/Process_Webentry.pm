...
G::RenderPage('publish', 'blank');000000015WebFormPost.php000004317<?php
 /***********************************************************************************************
  *                        --= Processmaker Web Entry Request handler =--                       * 
  *                                                                                             *
  *             This file was autogenerated by Processmaker Open Source  Rel-2.0.45-testing.4               *
  **********************************************************************************************/
   
  #@Dynaform  : WebForm
  #@Workspace : cochalo                                                                       
  #@Timestamp : Wednesday 16th of January 2013 08:14:39 PM                                                                                                                                                                                                     
   
  define ( 'WS_WSDL_URL',     'http://192.168.11.132/syscochalo/en/classic/services/wsdl2' );
  define ( 'WS_UPLOAD_URL',   'http://192.168.11.132/syscochalo/en/classic/services/upload' );
