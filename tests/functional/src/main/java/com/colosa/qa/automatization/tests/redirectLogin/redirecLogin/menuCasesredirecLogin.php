...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_REDIRECLOGIN_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../redirecLogin/redirecLoginApplication"; //link
    $tmpLabels[$index + $k]  = "redirecLogin application1";
    $tmpJS[$index + $k]      = null;
...
$tmpId[$i]      = "ID_REDIRECLOGIN_MNUCASE_02";
$tmpTypes[$i]   = "blockHeader";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = null; //link
$tmpLabels[$i]  = "redirecLogin application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_REDIRECLOGIN_MNUCASE_03";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../redirecLogin/redirecLoginApplication2"; //link
$tmpLabels[$i]  = "redirecLogin application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_REDIRECLOGIN_MNUCASE_04";
$tmpTypes[$i]   = "blockHeaderNoChild";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../redirecLogin/redirecLoginApplication3"; //link
$tmpLabels[$i]  = "redirecLogin application3";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
